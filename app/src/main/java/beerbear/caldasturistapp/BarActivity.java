...
public class BarActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.mBares:
                break;
            case R.id.mRest:
                intent = new Intent(BarActivity.this, RestauranteActivity.class);
                intent.putExtra("username",user);
                intent.putExtra("mail",mail);
                startActivity(intent);
                finish();
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return getResources().getString(R.string.bar1);
                case 1:
                    return getResources().getString(R.string.bar2);
                case 2:
                    return getResources().getString(R.string.bar3);
            }
            return null;
        }
    }
